...
# model 2
  ...
  out.write(line)
  line = "EQ_" + country + "_MD1.makeresids RES_MD2_" + country + "\r\n"
  out.write(line)
# model 3
  line = "equation EQ_" + country + "_MD3.ls (ST_" + country + " +  PT_UNITED_STATES) c PT_" + country + "\r\n"
  out.write(line)
  line = "EQ_" + country + "_MD1.makeresids RES_MD3_" + country + "\r\n"
  out.write(line)
# end
  ...
  gen_uroot(country, out, "RES_MD1_", "res_result")
  gen_uroot(country, out, "RES_MD2_", "res_result")
  gen_uroot(country, out, "RES_MD3_", "res_result")
